...
GO
:setvar DatabaseName "testpub"
:setvar DefaultFilePrefix "testpub"
:setvar DefaultDataPath "C:\Program Files\Microsoft SQL Server\MSSQL14.ELEKSDB\MSSQL\DATA\"
:setvar DefaultLogPath "C:\Program Files\Microsoft SQL Server\MSSQL14.ELEKSDB\MSSQL\DATA\"
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [secondary_1E09314F], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_secondary_1E09314F.mdf') TO FILEGROUP [secondary];
...
CREATE TABLE [dbo].[DBversion] (
    [DAversion] NCHAR (5) NOT NULL,
    [DateStart] DATETIME  NOT NULL,
    [DateEnd]   DATETIME  NOT NULL,
    PRIMARY KEY CLUSTERED ([DAversion] ASC)
);
...
GO
PRINT N'Creating [dbo].[StockChanges].[IX_ChangeDate]...';
